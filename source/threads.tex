...
(\tcode{m} denotes a value of type \tcode{L},
\tcode{rel_-time} denotes a value of a specialization of \tcode{chrono::duration}, and
\tcode{abs_-time} denotes a value of a specialization of \tcode{chrono::time_-point}).
